...
fichiers de définition TypeScript pour une librairie JavaScript donnée.
...
* Importer le module Express en TypeScript ([aide - importer un module](aide-importation-module.md)),
* Créer une nouvelle instance Express,
* Ecouter le port 8080.

> Correction : #resources-tp3-installation-solution
...
* Créez le `Router.ts`,
* Créez le controlleur `DocumentCtrl` dans le dossier controller 
et adaptez le code fait dans l'exercice 2.
* Ajoutez le `DocumentCtrl` à l'application Express dans `server.ts`.


> Correction : #resources-tp3-excercice-solution

[Suivant](tp4-express-ejs.md)